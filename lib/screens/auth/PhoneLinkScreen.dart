...
class PhoneLinkPhoneNumberScreen extends StatelessWidget {
                  ...
                  onPressed: () async {
                    if (_formKey.currentState.validate()) {
                      ...
                      Navigator.of(context).push(CupertinoPageRoute(
                        builder: (context) => PhoneLinkOTPScreen(
                          phoneNo: phoneNo,
...
class PhoneLinkOTPScreen extends StatelessWidget {
  GlobalKey<FormState> _formKey = GlobalKey<FormState>();
